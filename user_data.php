...
$susuarios  =!empty ($_POST["susuarios"]) ? $_POST["susuarios"] : NULL;
...
$toDate    =!empty ($_POST["to_date"])    ? $_POST["to_date"]    : NULL;
 ...
 if(isset($_POST["susuarios"], $_POST["agencia"], $_POST["codcli"], $_POST["from_date"], $_POST["to_date"]))  
 {  
      ...
      WHERE 4am_traficon.ts_horas.coduser IN ($susuarios)
          AND 4am_traficon.ts_horas.codempresa IN ($agencia)
          AND 4am_traficon.ts_horas.codclt IN ($codcli)
          AND 4am_traficon.ts_horas.fecha BETWEEN '$fromDate' AND '$toDate'
