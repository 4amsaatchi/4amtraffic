<?php
   ...
   $query = "SELECT * FROM ordint ORDER BY f_aprueba desc LIMIT 150 ORDER";
   $resultone = mysqli_query($connecttwo, $query);
   function fill_brand($connect) {
      $output = '';
      $sql = "SELECT * FROM climae ORDER BY nomcli ASC LIMIT 450";
            ...
            <div class="sidebar-wrapper">
               ...
               <ul class="nav">
                  ...
                  <li class="nav-item active">
                     <a class="nav-link" href="#"><i class="material-icons">content_paste</i><p>Reporte de Clientes</p></a>
                  </li>
                  <li class="nav-item">
               ...
               <div class="container-fluid">
                  <div class="row">
                     <div class="col-md-12">
                        <div class="row">
                           <div class="col-md-12">
                              <h3 style="text-align: center;">Selecione los siguientes datos para generar un reporte de ordenes por cliente:</h3>
                           </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                           <div class="col-md-12">
                              <h3 style="text-align: center;">Seleciona rango de fecha:</h3>
                           </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="consulta" id="order_table"></div>
                     </div>
                  </div>
               </div>
            </div>
...
downloadLink.click();
 ...
 function Exportar(){
        ...
        link.download = "Reporte de ordenes por cliente.xls";
