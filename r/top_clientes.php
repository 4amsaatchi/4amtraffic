<?php
   ...
   $query = "SELECT 4am_comsysn.climae.nomcli, 4am_traficon.ts_horas.fecHa, 4am_traficon.ts_horas.codclt, 
      ...
      WHERE 4am_traficon.ts_horas.fecha 
         BETWEEN '2019-01-01' AND '2019-05-08'
...
<html lang="es">
   ...
   <title>Top 10 Clientes con más ordenes</title>
            ...
            <div class="sidebar-wrapper">
               ...
               <ul class="nav">
                  ...
                  <li class="nav-item active">
                     <a class="nav-link" href="#"><i class="material-icons">group</i><p>Top 10 Clientes</p></a>
                  </li>
                  <li class="nav-item">
               ...
               <div class="container-fluid">
                  <div class="row">
                     <div class="col-md-12">
                        <div class="row">
                           <div class="col-md-12">
                              <h3 style="text-align: center;">Top 10 Clientes con más ordenes y su total de horas</h3>
                           </div>
                        </div>
                        <div class="row">
                                    ...
                                    <tbody>  
                                       ...
                                       ?>  
                                          <tr>  
                                             ...
                                             <td><?php echo $row["num_correlativo"]; ?></td>  
...
<script>
   function Exportar(){
      ...
      link.download = "Top 10 clientes con más ordenes.xls";
